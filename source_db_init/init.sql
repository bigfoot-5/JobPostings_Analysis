...
-- \COPY jobs(id, title, company, place, date_posted) FROM '/postings.csv' DELIMITER ',' CSV HEADER;

-- \COPY jobs(id, title, company, place, date_posted) FROM '/opt/airflow/elt_script/postings.csv' DELIMITER ',' CSV HEADER;
-- execute the copy command here using psql and \copy
